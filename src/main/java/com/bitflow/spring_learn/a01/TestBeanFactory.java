...
public class TestBeanFactory {
    ...
    public static void main(String[] args) {
        ...
        // 给 BeanFactory 添加一些常用的后置处理器 （也会设置比较器对象）
        ...
        // Common 和 Autowired 处理器的 order 值，值越小优先级越高
    ...
    static class Bean1 {
        ...
        // 如果两个注解都加上，则Autowired先生效
        @Autowired
        @Resource(name = "bean4")
        private Inter bean3; // 变量的名字会自动匹配
